        ...
        <div className="mx-4 mb-4">
            ...
            <div className="relative flex items-center">
                ...
                <button
                    ...
                    className="absolute left-2 z-10 w-10 h-10 bg-white/90 dark:bg-slate-600/90 rounded-full shadow-lg flex items-center justify-center hover:bg-white dark:hover:bg-slate-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                    <ChevronLeft size={24} className="text-gray-600 dark:text-white" />
                </button>

                {/* Movie Cards Container */}
                <div className="flex gap-4 w-full justify-center min-h-[320px] px-14">
                    {isLoading ? (
                        // Loading skeleton
                ...
                <button
                    onClick={goToNext}
                    disabled={movies.length === 0}
                    className="absolute right-2 z-10 w-10 h-10 bg-white/90 dark:bg-slate-600/90 rounded-full shadow-lg flex items-center justify-center hover:bg-white dark:hover:bg-slate-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
